...
from doctor.models import Document, Prescription
from doctor.forms import DocumentForm, PrescriptionForm
...
from doctor.forms import PatientRegistrationForm ,PatientPatientUpdateForm,PatientUserUpdateForm,DepartmentForm
import random
import string
